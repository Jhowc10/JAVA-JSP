...
/**
 *
 * Classe que realiza o LoginJSON utilizando o formato JSON para troca de mensagens
 */
public class LoginJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Executa a chamada ao método LoginJSON e atribui o resultado um uma lista
